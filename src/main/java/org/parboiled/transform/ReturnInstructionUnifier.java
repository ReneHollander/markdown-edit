...
/**
 * Replaces all "non-last" return instructions with goto instructions to the last return instruction. If a method contains only one return instruction the transformer does nothing.
 */
