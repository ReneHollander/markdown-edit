...
/**
 * A {@link ParseRunner} implementation that creates an {@link org.parboiled.errors.InvalidInputError} for the error at a known error location. It never causes the parser to perform more than one parsing run and is rarely used directly. Instead its functionality is relied
 * upon by the {@link org.parboiled.parserunners.ReportingParseRunner} and {@link org.parboiled.parserunners.RecoveringParseRunner} classes.
 */
