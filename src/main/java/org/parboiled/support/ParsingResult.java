...
public class ParsingResult<V> {
	 ...
	 *
	 * @param matched
	 *            true if the rule matched the input
	 * @param parseTreeRoot
	 *            the parse tree root node
	 * @param valueStack
	 *            the value stack of the parsing run
	 * @param parseErrors
	 *            the list of parse errors
	 * @param inputBuffer
	 *            the input buffer
	 */
	public ParsingResult(boolean matched, Node<V> parseTreeRoot, ValueStack<V> valueStack, List<ParseError> parseErrors, InputBuffer inputBuffer) {
