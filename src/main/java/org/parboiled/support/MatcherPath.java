...
/**
 * Holds a snapshot of the current {@link Matcher} stack at a certain point during the parsing process. Implemented as a specialized, immutable single-linked list of Element objects with the deepest stack Element in the first position and the root at the end.
 */
public class MatcherPath {
	...
	/**
	 * Constructs a new MatcherPath wrapping the given elements. Normally you don't construct a MatcherPath directly but rather call {@link org.parboiled.Context#getPath()} to get one.
	 *
	 * @param element
	 ...
	 * 
	 * @param level
	 *            the level to get the element from
	 * @return the element
	 */
