...
/**
 * A Matcher instance is responsible for "executing" a specific Rule instance, i.e. it implements the actual rule type specific matching logic. Since it extends the {@link org.parboiled.trees.GraphNode} interface it can have submatchers.
 */
public interface Matcher extends Rule, GraphNode<Matcher> {
	...
	/**
	 * Associates an arbitrary object with this matcher. Used for example during profiling and packrat parsing. The matcher implementations themselves completely ignore the contents of this property. It purely serves as a performance optimization for ParseRunners and/or MatchHandlers and saves these
	 * from the need to use Map&lt;Matcher, XYZ&gt; structures for associating internal objects with matchers.
	 *
	 * @param tagObject
	 *            the tag object
	 */
