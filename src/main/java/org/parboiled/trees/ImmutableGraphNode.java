...
/**
 * A simple, immutable {@link org.parboiled.trees.GraphNode} implementation.
 *
 * @param <T>
...
public class ImmutableGraphNode<T extends GraphNode<T>> implements GraphNode<T> {
	...
	public ImmutableGraphNode(List<T> children) {
		this.children = children == null ? ImmutableList.<T> of() : children instanceof ImmutableList ? children : children instanceof ImmutableLinkedList ? children : ImmutableList.copyOf(children);
	}
