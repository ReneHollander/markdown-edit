...
/**
 * General utility methods for operating on tree, i.e. graphs consisting of {@link org.parboiled.trees.TreeNode}s.
 */
public final class TreeUtils {
	 ...
	 * @return the new root after the transformation, which is either the right sub node of the original root or the original root, if the right sub node is null
	 */
