...
/**
 * A special {@link org.parboiled.matchers.Matcher} not actually matching any input but rather trying its submatcher against the current input position. Succeeds if the submatcher would fail.
 */
