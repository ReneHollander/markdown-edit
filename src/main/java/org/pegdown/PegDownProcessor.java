...
public class PegDownProcessor {
	...
	/**
	 * Creates a new processor instance with the given {@link Extensions} and the default parsing timeout.
	 *
	 * @param options
	...
	/**
	 * Creates a new processor instance with the given {@link Extensions} and parsing timeout.
	 *
	 * @param options
	 *            the flags of the extensions to enable as a bitmask
	...
	/**
	 * Creates a new processor instance with the given {@link Extensions} and plugins.
	 *
	 * @param options
	 *            the flags of the extensions to enable as a bitmask
	 * @param plugins
	...
	/**
	 * Creates a new processor instance with the given {@link Extensions}, parsing timeout and plugins.
	 *
	 * @param options
	 *            the flags of the extensions to enable as a bitmask
	 * @param maxParsingTimeInMillis
