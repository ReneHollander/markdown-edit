...
/**
 * An implementation of a stack of value objects providing an efficient snapshot capability and a number of convenience methods. The current state of the stack can be saved and restored in small constant time with the methods {@link #takeSnapshot()} and {@link #restoreSnapshot(Object)} ()}. The
 * implementation also serves as an Iterable over the current stack values (the values are being provided with the last value (on top of the stack) first).
 *
 * @param <V>
...
public class DefaultValueStack<V> implements ValueStack<V> {
	...
	public void swap4() {
		...
		head = new Element(down3.value, new Element(down2.value, new Element(down1.value, new Element(head.value, down3.tail))));
	}
	...
	public void swap5() {
		...
		head = new Element(down4.value, new Element(down3.value, new Element(down2.value, new Element(down1.value, new Element(head.value, down4.tail)))));
	}
	...
	public void swap6() {
		...
		head = new Element(down5.value, new Element(down4.value, new Element(down3.value, new Element(down2.value, new Element(down1.value, new Element(head.value, down5.tail))))));
	}
