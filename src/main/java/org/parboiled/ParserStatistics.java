...
public class ParserStatistics implements MatcherVisitor<ParserStatistics> {
	...
	public ParserStatistics visit(FirstOfMatcher matcher) {
		return matcher instanceof FirstOfStringsMatcher ? visit((FirstOfStringsMatcher) matcher, firstOfStringMatchers) : visit(matcher, firstOfMatchers);
	}
	...
	public ParserStatistics visit(SequenceMatcher matcher) {
		return matcher instanceof StringMatcher ? visit((StringMatcher) matcher, stringMatchers) : visit(matcher, sequenceMatchers);
	}
