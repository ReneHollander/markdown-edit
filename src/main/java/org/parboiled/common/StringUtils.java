...
public final class StringUtils {
	...
	/**
	 * Replaces carriage returns, newlines, tabs, formfeeds and the special chars defined in {@link Characters} with their respective escape sequences.
	 *
	 * @param string
	 *            the string
	 ...
	 * <p/>
	 * StringUtils.startsWith(null, null) = false StringUtils.startsWith(null, "abc") = false StringUtils.startsWith("abc", null) = true StringUtils.startsWith("abc", "ab") = true StringUtils.startsWith("abc", "abc") = true
	 *
	 * @param string
	 *            the string
	 * @param prefix
	 ...
	 * <p/>
	 * <p>
	 * The returned substring starts with the character in the <code>start</code> position and ends before the <code>end</code> position. All position counting is zero-based -- i.e., to start at the beginning of the string use <code>start = 0</code>. Negative start and end positions can be used to
