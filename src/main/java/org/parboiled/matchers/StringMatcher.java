...
/**
 * A {@link SequenceMatcher} specialization for sequences of CharMatchers. Performs fast string matching if the current context has it enabled.
 */
public class StringMatcher extends SequenceMatcher {
	...
	public boolean match(MatcherContext context) {
		...
		if (!context.getInputBuffer().test(context.getCurrentIndex(), characters))
			return false;
