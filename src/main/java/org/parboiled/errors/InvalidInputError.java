...
/**
 * A {@link org.parboiled.errors.ParseError} describing one or more input characters that are illegal with regard to the underlying language grammar.
 */
public class InvalidInputError extends BasicParseError {
	private final List<MatcherPath> failedMatchers;

	public InvalidInputError(InputBuffer inputBuffer, int startIndex, List<MatcherPath> failedMatchers, String errorMessage) {
